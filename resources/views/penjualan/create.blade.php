                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary btn-tambah" type="button" data-action="tambah" data-id="{{ $barang->barang_id }}"><i class="fas fa-plus"></i></button>
                                    <button class="btn btn-outline-secondary btn-kurang" type="button" data-action="kurang" data-id="{{ $barang->barang_id }}"><i class="fas fa-minus"></i></button>
                                </div>
                            </div>
                        </div>
                    @endforeach
